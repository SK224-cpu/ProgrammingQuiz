...
def SendQuizToShruti():
    ...
    quizEmailTemplate = generate_email_html_N_plaintext("Shruti", quizQuestions)
    SendEmail(quizEmailTemplate[0], quizEmailTemplate[1], "shrutikhonde412@gmail.com")
